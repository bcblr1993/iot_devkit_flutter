...
class _PerformanceMonitorState extends State<PerformanceMonitor>
              ...
              return Row(
                children: [
                  ...
                  Expanded(
                      child: _buildMetricCard(
                          context,
                          l10n?.dashboardBandwidth ?? 'Bandwidth',
                  ...
                  Expanded(
                      child: _buildMetricCard(
                          context,
                          l10n?.dashboardLatency ?? 'Avg Latency',
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      ...
                      _buildLiveChart<StatisticsCollector>(
                          color: Colors.purple,
                          dataSelector: (s) =>
                              s.tpsHistory // TODO: Add bandwidth history
                          ),
                    ],
                  ),
                ),
  ...
  Widget _buildLiveChart<T>({
    ...
    required List<Map<String, double>> Function(StatisticsCollector)
        dataSelector,
  }) {
                  ...
                  sideTitles: SideTitles(
                    ...
                    getTitlesWidget: (value, meta) {
                      return const SizedBox
                          .shrink(); // Hide bottom headers for cleaner look, or show '10s', '20s'
                    },
                  ),
                ),
