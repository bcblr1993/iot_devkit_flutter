...
void main() {
  group('DataGenerator Tests', () {
    ...
    test('generateBatteryStatus generates correct number of keys', () {
      final data =
          DataGenerator.generateBatteryStatus(10, clientId: 'test_client');
    ...
    test('Custom Keys - Static Mode', () {
      final keys = [
        CustomKeyConfig(
            ...
            staticValue: 'fixed_val')
      ];

      final data = DataGenerator.generateBatteryStatus(5,
          clientId: 'test', customKeys: keys);
    ...
    test('Custom Keys - Increment Mode', () {
      ...
      var data = DataGenerator.generateBatteryStatus(5,
          clientId: 'test', customKeys: keys);
      expect(data['inc_test'], 1);

      data = DataGenerator.generateBatteryStatus(5,
          clientId: 'test', customKeys: keys);
